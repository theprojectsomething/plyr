typeof navigator === "object" && (function (Sentry) {
	'use strict';
	...
	*/
	...
	var HAS_SPECIES_SUPPORT$3 = arrayMethodHasSpeciesSupport$1('filter');
	// Edge 14- issue
	var USES_TO_LENGTH$7 = arrayMethodUsesToLength$1('filter');
	...
	var USES_TO_LENGTH$8 = arrayMethodUsesToLength$1(FIND$1);
	...
	// `Array.prototype.includes` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.includes
	_export$1({ target: 'Array', proto: true, forced: !USES_TO_LENGTH$9 }, {
	  includes: function includes(el /* , fromIndex = 0 */) {
	...
	var setToStringTag$1 = function (it, TAG, STATIC) {
	  if (it && !has$2(it = STATIC ? it : it.prototype, TO_STRING_TAG$6)) {
	    defineProperty$8(it, TO_STRING_TAG$6, { configurable: true, value: TAG });
	  }
	};
	...
	// FF49- issue
	var USES_TO_LENGTH$a = arrayMethodUsesToLength$1('map');
	...
	var STRICT_METHOD$4 = arrayMethodIsStrict$1('every');
	var USES_TO_LENGTH$b = arrayMethodUsesToLength$1('every');

	// `Array.prototype.every` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.every
	_export$1({ target: 'Array', proto: true, forced: !STRICT_METHOD$4 || !USES_TO_LENGTH$b }, {
	...
	var USES_TO_LENGTH$c = arrayMethodUsesToLength$1('forEach');

	// `Array.prototype.forEach` method implementation
	// https://tc39.github.io/ecma262/#sec-array.prototype.foreach
	var arrayForEach$1 = (!STRICT_METHOD$5 || !USES_TO_LENGTH$c) ? function forEach(callbackfn /* , thisArg */) {
	...
	// `Array.prototype.indexOf` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.indexof
	_export$1({ target: 'Array', proto: true, forced: NEGATIVE_ZERO$1 || !STRICT_METHOD$6 || !USES_TO_LENGTH$d }, {
	  indexOf: function indexOf(searchElement /* , fromIndex = 0 */) {
	  ...
	  return [
	    ...
	    function (regexp, limit) {
	      ...
	      while (q < S.length) {
	        ...
	        if (
	          z === null ||
	          (e = min$6(toLength$1(splitter.lastIndex + (SUPPORTS_Y$1 ? 0 : q)), S.length)) === p
	        ) {
	...
	var USES_TO_LENGTH$e = arrayMethodUsesToLength$1('some');

	// `Array.prototype.some` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.some
	_export$1({ target: 'Array', proto: true, forced: !STRICT_METHOD$7 || !USES_TO_LENGTH$e }, {
	...
	_export$1({ target: 'Number', proto: true, forced: FORCED$4 }, {
	  // eslint-disable-next-line max-statements
	  ...
	  return [
	    ...
	    function (regexp, replaceValue) {
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var matched = String(result[0]);
	        var position = max$4(min$7(toInteger$1(result.index), S.length), 0);
	        var captures = [];
	        // NOTE: This is equivalent to
	        //   captures = result.slice(1).map(maybeToString)
	        // but for some reason `nativeSlice.call(result, 1, result.length)` (called in
	...
	var FORCED$5 = !descriptors$1 || FAILS_ON_PRIMITIVES$2;
	...
	var FORCED$6 = isForced_1$1(PROMISE$1, function () {
	...
	var INCORRECT_ITERATION$3 = FORCED$6 || !checkCorrectnessOfIteration$1(function (iterable) {
	...
	// statics
	_export$1({ target: PROMISE$1, stat: true, forced: FORCED$6 }, {
	  // `Promise.reject` method
	  // https://tc39.github.io/ecma262/#sec-promise.reject
	  reject: function reject(r) {
	...
	var isTrack = function isTrack(input) {
	  return instanceOf$2(input, TextTrack) || !isNullOrUndefined$2(input) && isString$2(input.kind);
	};
	...
	var isEmpty$2 = function isEmpty(input) {
	  return isNullOrUndefined$2(input) || (isString$2(input) || isArray$4(input) || isNodeList$2(input)) && !input.length || isObject$4(input) && !Object.keys(input).length;
	};
	...
	var arrayReduce = {
	  ...
	  left: createMethod$a(false),
	  // `Array.prototype.reduceRight` method
	  // https://tc39.github.io/ecma262/#sec-array.prototype.reduceright
	  right: createMethod$a(true)
	};
	...
	// `Array.prototype.reduce` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.reduce
	_export$1({ target: 'Array', proto: true, forced: !STRICT_METHOD$8 || !USES_TO_LENGTH$f }, {
	...
	var HAS_SPECIES_SUPPORT$5 = arrayMethodHasSpeciesSupport$1('slice');
	...
	// https://tc39.github.io/ecma262/#sec-array.prototype.slice
	// fallback for not array-like ES3 strings and DOM objects
	_export$1({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$5 || !USES_TO_LENGTH$g }, {
	  slice: function slice(start, end) {
	    var O = toIndexedObject$1(this);
	    var length = toLength$1(O.length);
	...
	var FORCED$7 = descriptors$1 && isForced_1$1('RegExp', (!CORRECT_NEW$1 || UNSUPPORTED_Y$5 || fails$1(function () {
	  re2$1[MATCH$5] = false;
	  // RegExp constructor can alter flags and IsRegExp works correct with @@match
	...
	var HAS_SPECIES_SUPPORT$6 = arrayMethodHasSpeciesSupport$1('splice');
	var USES_TO_LENGTH$h = arrayMethodUsesToLength$1('splice', { ACCESSORS: true, 0: 0, 1: 2 });
	...
	// with adding support of @@species
	_export$1({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$6 || !USES_TO_LENGTH$h }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$9(max$6(toInteger$1(deleteCount), 0), len - actualStart);
	    }
	...
	var media = {
	  ...
	  setup: function setup() {
	    ...
	    if (this.isVideo) {
	      ...
	      wrap$3(this.media, this.elements.wrapper); // Poster image container
	...
	var USES_TO_LENGTH$i = arrayMethodUsesToLength$1(FIND_INDEX);
	...
	// `Array.prototype.findIndex` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.findindex
	_export$1({ target: 'Array', proto: true, forced: SKIPS_HOLES$2 || !USES_TO_LENGTH$i }, {
	...
	var NEGATIVE_ZERO$2 = !!nativeLastIndexOf && 1 / [1].lastIndexOf(1, -0) < 0;
	var STRICT_METHOD$9 = arrayMethodIsStrict$1('lastIndexOf');
	// For preventing possible almost infinite loop in non-standard implementations, test the forward version of the method
	var USES_TO_LENGTH$j = arrayMethodUsesToLength$1('indexOf', { ACCESSORS: true, 1: 0 });
	var FORCED$8 = NEGATIVE_ZERO$2 || !STRICT_METHOD$9 || !USES_TO_LENGTH$j;

	// `Array.prototype.lastIndexOf` method implementation
	// https://tc39.github.io/ecma262/#sec-array.prototype.lastindexof
	var arrayLastIndexOf = FORCED$8 ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
	  // convert -0 to +0
	  if (NEGATIVE_ZERO$2) return nativeLastIndexOf.apply(this, arguments) || 0;
	  var O = toIndexedObject$1(this);
	  var length = toLength$1(O.length);
	  var index = length - 1;
	  if (arguments.length > 1) index = min$a(index, toInteger$1(arguments[1]));
